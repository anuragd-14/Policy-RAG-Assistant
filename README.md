...
> Usage:
    ...
    3. Run Evaluation: Test the system against the predefined question set.
        python evaluate.py
        <img width="1316" height="664" alt="Screenshot 2026-02-06 192140" src="https://github.com/user-attachments/assets/b04f0c83-46b2-483f-82c6-0ff62e3d8134" />
...
6. Prompt Engineering (Iteration Process)
